...
MIDDLEWARE: list[str] = [
    ...
    "{{ project_slug }}.middleware.HtmxRestoreMiddleware",
    "{{ project_slug }}.middleware.HtmxMessagesMiddleware",
    "{{ project_slug }}.middleware.HtmxRedirectMiddleware",
]
...
ADMIN_SITE_HEADER = env("ADMIN_SITE_HEADER", default="{{ project_name }} Admin")
...
PWA_CONFIG = {
    "assetlinks": {
        "package_name": env("PWA_PACKAGE_NAME", default="app.{{ project_slug }}.twa"),
    ...
    "manifest": {
        ...
        "description": env("PWA_DESCRIPTION", default="{{ description }}"),
