...
MIDDLEWARE: list[str] = [
    ...
    "{{ cookiecutter.project_slug }}.middleware.HtmxRestoreMiddleware",
    "{{ cookiecutter.project_slug }}.middleware.HtmxMessagesMiddleware",
    "{{ cookiecutter.project_slug }}.middleware.HtmxRedirectMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "builtins": [
                ...
                "{{ cookiecutter.project_slug }}.templatetags",
            ],
...
ADMIN_SITE_HEADER = env("ADMIN_SITE_HEADER", default="{{ cookiecutter.project_name }} Admin")
